...
// Always redirect back to the production domain, not a Vercel preview URL.
// Set NEXT_PUBLIC_SITE_URL in your Vercel environment variables to your
// production domain (e.g. https://inlightoftheword.com).
function getSiteUrl() {
    ...
    try {
      if (mode === 'login') {
        ...
        const { error } = await supabase.auth.signUp({
          ...
          options: {
            data: { full_name: name },
            // Ensures the confirmation email link points to your production
            // domain, not a Vercel preview URL.
