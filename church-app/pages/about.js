...
export default function AboutPage({ user, profile }) {
  return (
    <>
      <Head>
        <title>About — In Light of the Word</title>
        <meta name="description" content="Learn about DeKUSDA's In Light of the Word ministry and our mission to proclaim God's Word." />
        <meta property="og:title" content="About — In Light of the Word" />
        <meta property="og:description" content="Learn about DeKUSDA's In Light of the Word ministry and our mission to proclaim God's Word." />
      ...
      <section className="hero-pattern text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-14 sm:py-20 text-center">
          ...
          <p className="font-body text-lg text-blue-200 leading-relaxed max-w-2xl mx-auto">
            DeKUSDA's In Light of the Word publication ministry exists to share the everlasting gospel
        ...
        <section className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="space-y-4 font-body text-lg text-slate-700 leading-relaxed">
              <p>
                The <strong>DeKUSDA In Light of the Word</strong> publication ministry was founded on the conviction
      ...
      <footer className="hero-pattern text-white mt-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 text-center">
          <p className="font-ui text-sm text-blue-300">
            © <span suppressHydrationWarning>{new Date().getFullYear()}</span> DeKUSDA In Light of the Word Ministry &nbsp;·&nbsp;
