          ...
          <tr>
            <td style="background:#f8faff;border-top:1px solid #e2e8f0;padding:20px 40px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.6;">
                This email was sent by the <strong>DeKUSDA Silent Witness</strong> editorial team.<br/>
...
— DeKUSDA Silent Witness Editorial Team
`
}
...
export default async function handler(req, res) {
  ...
  const mailOptions = {
    from: `"Silent Witness — DeKUSDA" <${gmailUser}>`,
    to:   authorEmail,
