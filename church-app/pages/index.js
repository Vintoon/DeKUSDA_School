  ...
  return (
    <div className="w-full overflow-x-hidden">
      <Head>
        ...
        <meta name="description" content="Church publications, sermons, devotionals, Bible studies and testimonies — freely shared to proclaim God's Word." />
        <link rel="icon" href="/logo.png" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        {/* Open Graph */}
        <meta property="og:title" content="In Light of the Word — Truth in every page" />
        <meta property="og:description" content="Church publications, sermons, devotionals, Bible studies and testimonies — freely shared to proclaim God's Word." />
        ...
        <meta name="twitter:description" content="Church publications, sermons, devotionals, Bible studies and testimonies — freely shared to proclaim God's Word." />
