...
export default function ProfilePage({ user, profile, authReady, refreshProfile }) {
  ...
  if (!authReady || !profile) {
    return (
      <div className="w-full overflow-x-hidden">
        <Head><title>My Profile – In Light of the Word</title></Head>
  ...
  return (
    <div className="w-full overflow-x-hidden bg-slate-50 min-h-screen">
      <Head>
        <title>My Profile – In Light of the Word</title>
        <meta name="description" content="Manage your In Light of the Word profile and publications." />
      ...
      <footer className="hero-pattern text-white mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 text-center">
          <p className="font-ui text-sm text-blue-300">© {new Date().getFullYear()} In Light of the Word. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
