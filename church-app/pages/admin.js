...
export default function AdminPage({ user, profile, authReady, profileReady, refreshProfile }) {
  ...
  // 1. Auth not yet restored from storage → full-page spinner
  ...
  // 2. Auth resolved, no session → show lock screen
  // 3. Auth resolved, has session, profile loaded, not an admin → show lock screen
  // NOTE: we only reach here once profileReady=true, so profile is trustworthy.
