      ...
      <div className="bg-brand-800 border-b border-brand-700">
        <div className="max-w-7xl mx-auto px-4 flex gap-1">
          <button onClick={() => { setSection('publications'); loadPublications(pubTab) }}
            className={`flex items-center gap-2 px-5 py-3 font-ui text-sm font-semibold border-b-2 transition-all ${section === 'publications' ? 'border-white text-white' : 'border-transparent text-blue-300 hover:text-white'}`}>
          ...
          <button onClick={() => { setSection('users'); loadUsers() }}
            className={`flex items-center gap-2 px-5 py-3 font-ui text-sm font-semibold border-b-2 transition-all ${section === 'users' ? 'border-white text-white' : 'border-transparent text-blue-300 hover:text-white'}`}>
