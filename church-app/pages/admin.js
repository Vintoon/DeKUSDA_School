...
export default function AdminPage({ user, profile, authReady, refreshProfile }) {
  ...
  const NAV = [
    ...
    { key:'sermons',      icon:'🎙️', label:'Sermons' },
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 mb-8">
              ...
              <form onSubmit={submitDevotional} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea value={devotForm.content} onChange={e => setDevotForm(p => ({ ...p, content: e.target.value }))} placeholder="Write the devotional reflection here…" rows={5} className="w-full border border-slate-200 rounded-xl px-3 py-2.5 font-ui text-sm outline-none focus:border-purple-400 resize-none" />
                </div>
                <div className="flex items-center gap-3">
        ...
        {section === 'sermons' && (
          <div className="max-w-2xl">
            <h2 className="font-display text-xl font-bold text-slate-800 mb-6">🎙️ Sermon Archive</h2>
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 mb-8">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/sermons" target="_blank" className="font-ui text-xs text-brand-600 hover:underline flex items-center gap-1"><HiExternalLink size={12} /> View public page</Link>
            </div>
            {sermonLoading ? (
