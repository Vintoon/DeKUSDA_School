  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 shadow-md overflow-hidden mb-10">
      ...
      <div className="p-7 sm:p-8">
        ...
        {/* Devotional content */}
        <div className="font-body text-slate-700 text-base sm:text-lg leading-relaxed whitespace-pre-line">
          {devotional.content}
        </div>
    ...
    <div className="bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
      ...
      {expanded && (
        <div className="px-5 pb-5 pt-1 border-t border-slate-100">
          ...
          <p className="font-body text-slate-700 leading-relaxed whitespace-pre-line">{devotional.content}</p>
          {devotional.author_name && (
