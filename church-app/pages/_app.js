...
export default function App({ Component, pageProps }) {
  ...
  useEffect(() => {
    ...
    // ── STEP 3: Mobile Safari fix.
    // iOS freezes the page when you switch apps. When you return, the JWT
    // may have expired without a TOKEN_REFRESHED event firing. Re-check the
    // session whenever the tab becomes visible again so the user is never
    // silently logged out just from switching apps.
